...
<div class="row border rounded w-25">
    ...
    <div class="col">
        <input type="text" bind:this={searchBarController} bind:value={searchBar} onkeyup={() => filterData(searchBar)} class="form-control form-control-sm form-control-flush" placeholder="[ESC] Pencarian..." />
    </div>
</div>
