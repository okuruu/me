<script lang="ts">
    ...
    let quranChapters: Chapters[] = $state(data.quran);
...
<div class="bg-dark {quranChapters.length < 9 ? 'min-vh-100' : ''}">
    <div class="container-xs">
        ...
        <div class="row ">
            <div class="col-9">
                <input type="text" bind:this={searchBar} onkeyup={searchSurah} class="form-control form-control-transparent bg-dark text-white shadow" placeholder="[ESC] Cari Ayat" />
            </div>
            <div class="col-3">
