<script lang="ts">
    ...
    let mathExercise: Maths[] = $state([]);
    let timer: number = $state(6000);
    ...
    <div class="container-xs">
        ...
        {#each mathExercise as math, index }
            <div class="form-group mb-5">
                ...
                <button type="button" onclick={() => setAnswer(index, math.options.A)} class="btn btn-sm btn-dark text-white border me-1">{math.options.A}</button>
                <button type="button" onclick={() => setAnswer(index, math.options.B)} class="btn btn-sm btn-dark text-white border me-1">{math.options.B}</button>
                <button type="button" onclick={() => setAnswer(index, math.options.C)} class="btn btn-sm btn-dark text-white border me-1">{math.options.C}</button>
                <button type="button" onclick={() => setAnswer(index, math.options.D)} class="btn btn-sm btn-dark text-white border me-1">{math.options.D}</button>
            </div>
        {/each}
    </div>
</div>