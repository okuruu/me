        ...
        <div class="card card-flush shadow-sm bg-white my-5">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <button type="button" onclick={previousPage} class="btn btn-sm btn-secondary me-2">Kembali ke Beranda</button>
                    <button type="button" onclick={openModal} class="btn btn-sm btn-primary">Lihat Password</button>
                </div>
            </div>
