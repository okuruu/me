<script lang="ts">
    ...
    let searchBarController:HTMLElement = $state();
    ...
    let enableMSDT: boolean = $state();
    let enableCFIT: boolean = $state();
    let enableMBTI: boolean = $state();
    let enableBAUM: boolean = $state();
    let enableDISC: boolean = $state();
    let enableRMIB: boolean = $state();
    let enableKraeplin: boolean = $state();
    let enablePapikostick: boolean = $state();
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <div class="me-2">
                        ...
                        <button type="button" onclick={logOut} class="btn btn-sm btn-danger">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-end">
                    <div class="form-group">
                        <input type="text" bind:this={searchBarController} bind:value={searchBar} onkeyup={() => filterData(searchBar)} class="form-control form-control-sm" placeholder="[ESC] Pencarian..." />
                    </div>
                </div>
...
{#if isModal}
    <Modal open={isModal} onClose={closeModal}>
        ...
        <form onsubmit={preventDefault(createCandidate)}>
...
<svelte:window onkeydown={keyPrompt} />