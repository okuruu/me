<script lang="ts">
    ...
    let whatsapp: number = $state();
    let birthDate: Date = $state();
    let gender: "Pria" | "Wanita" = $state("Pria");
        ...
        <div class="card bg-white shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-end mb-5">
                    <button type="button" onclick={logOut} class="btn btn-sm btn-dark">
                        <img src="/icons/elements/Log-Out.svg" alt="Log Out Icon" class=" h-20px"/>
                    </button>
                </div>
                <form onsubmit={preventDefault(doPost)}>
