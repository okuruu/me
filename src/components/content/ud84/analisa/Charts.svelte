...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <div class="card bg-base-100 shadow-sm">
        <div class="card-body">
            <span class="inline-block w-8 text-success">
            ...
            <div class="mt-4 text-2xl font-bold text-success sm:text-3xl">{ rupiahFormatter.format(omsetBulan) }</div>
            <div class="font-semibold text-base-content/60">Omset Bulan: {bulanSekarang}</div>
        </div>
    </div>

    <div class="card bg-base-100 shadow-sm">
        <div class="card-body">
            <span class="inline-block w-8 text-error">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="mt-4 text-2xl font-bold text-error sm:text-3xl">{ rupiahFormatter.format(operasionalBulan) }</div>
            <div class="font-semibold text-base-content/60">Biaya Operasional: { bulanSekarang }</div>
        </div>
    </div>

    <div class="card bg-base-100 shadow-sm sm:col-span-2 lg:col-span-1">
        <div class="card-body">
            <span class="inline-block w-8 text-primary">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="mt-4 text-2xl font-bold text-primary sm:text-3xl">{ rupiahFormatter.format(bersihBulan) }</div>
            <div class="font-semibold text-base-content/60">Keuntungan Bersih: {bulanSekarang}</div>
        </div>
    </div>
